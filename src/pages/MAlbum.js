...
const MAlbum = () => {
    ...
    const columns=[
        ...
        },
        {
            ...
            renderCell: (params) => {
                return(
                    <div className="albumListArtist" style={{display:'flex',flexDirection:'row', justifyContent:'space-around'}}>
        ...
        },
        {
            ...
            renderCell: (params) => {
                return(
                    <div className="songs" style={{display:'flex',flexDirection:'row', justifyContent:'space-around'}}>
